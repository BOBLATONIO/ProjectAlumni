<x-layout.admin-layout pageTitle="Manage Alumni">
        ...
        <div class="flex flex-col items-start justify-between py-3 ">
            <div class="flex items-center justify-between text-sm  w-full">
                ...
                <div class="flex gap-2">
                    ...
                    <div class="filter-toggle-btn  relative">
                        <button
                            class=" appearance-none flex  items-center gap-1 w-full pl-2 pr-8 text-gray-700 bg-gray-50 border-gray-300 hover:bg-gray-100 border rounded-sm text-sm py-1 text-start focus:outline-none">
                        ...
                        {{-- Add this if the filter is active --}}
                        <div class="absolute -top-0.5 w-2.5 -right-0.5 h-2.5 rounded-full bg-blue-600 text-xs"></div>



                        <svg class="w-2.5 h-2.5 absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none"
                        ...
                        <div
                            class="filter-panel hidden absolute z-50 bg-gray-50  shadow-xl w-64 rounded-sm border p-3 top-0 right-0">
                            <div class="flex justify-between border-b -mx-3 px-3  items-center pb-2  mb-3">
                                <div class="font-medium text-lg">All Filters</div>
                            ...
                            <div class="flex gap-3 flex-col">
                                <div class="flex items-center">
                                    ...
                                    <div class="relative w-full">
                                        <select
                                            ...
                                            <option value="option1">IITI</option>
                                            <option value="option2">Education</option>
                                            <option value="option3">Accountandscdsfsfsdfsdcy</option>
                                ...
                                <div class="flex items-center">
                                    <div class=" mr-3">Program: </div>
                                    <div class="relative w-full">
                                        <select
                                            class="block appearance-none w-full text-gray-700 bg-gray-50 border-gray-300  border-b text-sm py-1 text-start focus:outline-none">
                                            <option value="">All</option>
                                            <option value="option1">BSIT</option>
                                            <option value="option2">BSEd English</option>
                                            <option value="option3">BSCS</option>
                                            <option value="option4">BSHR</option>
                                        </select>
                                        <svg class="w-2.5 h-2.5 absolute right-2 top-1/2 transform -translate-y-1/2 pointer-events-none"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div class="flex items-center">
                                    <div class="mr-3 whitespace-nowrap">Batch Year: </div>
                                    <div class="relative w-full">
                                        <select
                                            class="block appearance-none w-full text-gray-700 bg-gray-50 border-gray-300  border-b text-sm py-1 text-start focus:outline-none">
                                            <option value="">All</option>
                                            ...
                                            <option value="option4">2024</option>
                                        </select>
                                        <svg class="w-2.5 h-2.5 absolute right-2 top-1/2 transform -translate-y-1/2 pointer-events-none"
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div class="relative flex gap-2 w-full pt-2  text-center">
                                    <div
                                        ...
                                        Reset</div>
                                    <div
                                        class="block w-1/2  bg-[#273461] text-center border-[#273461] text-gray-50 hover:bg-gray-100 border rounded-sm text-sm py-1 focus:outline-none">
                                        Apply</div>
                                </div>
                            </div>
                        </div>
    ...
    <x-slot:modal>
        {{-- Confirmation Modal --}}
        <div class="fixed hidden inset-0 flex  items-center justify-center bg-black bg-opacity-30 z-50">
