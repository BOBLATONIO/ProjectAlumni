    ...
    <div class="flex items-center justify-between w-full ">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('admin-announcement') }}"
                class=" hover:bg-gray-300 border-gray-300 border text-sm py-2 px-3 rounded-md flex gap-1 items-center">
            ...
            @if (!request()->is('admin/pending-announcement'))
            <a href="{{ route('admin-pending-announcement') }}"
                class=" hover:bg-gray-300 border-gray-300 border text-sm py-2 px-3 rounded-md flex gap-1 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5">
                    <path fill-rule="evenodd"
            ...
            @if (!request()->is('admin/sched-del-announcement'))
            <a href="{{ route('admin-sched-del-announcement') }}"
                class=" hover:bg-gray-300 border-gray-300 border text-sm py-2 px-3 rounded-md flex gap-1 items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5">
                    <path fill-rule="evenodd"
