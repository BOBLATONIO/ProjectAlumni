        ...
        <div class="flex h-16 items-center justify-between 2xl:h-20">
            <div class="flex-1 flex items-center ">
                ...
                <a {{ !request()->is('questionnaire') ? 'href='.route('home') : '' }}
                    class="ml-2 text-xl font-bold uppercase text-[#273461] dark:text-gray-200 md:hidden
                    custom-1110:block">
                    BTECH
                    ALUMNI
                </a>
                ...
                <nav aria-label="Global Navigation" class="hidden md:block">
                    <ul class="navbar-ul flex items-center gap-8 text-sm font-medium">
                        <li>
                            ...
                            <span class=" h-[2px] w-9 bg-[#273461] dark:bg-white mx-auto mt-1 mb-[-5px]
                                    {{ request()->is('home') ? 'block' : 'hidden' }}"></span>
                        </li>
                        <li>
                            <a class=" transition  dark:hover:text-white  whitespace-nowrap     
                                {{ request()->is('tracer-study') ? 'text-[#273461]  font-semibold dark:text-white' : 'hover:text-gray-500 text-gray-700 dark:text-gray-300' }}"
                                href="{{ route('tracer-study') }}">Tracer Study</a>
                        ...
                        <li>
                            ...
                            <span class=" h-[2px] w-14 bg-[#273461] dark:bg-white mx-auto mt-1 mb-[-5px]
                        ...
                        <li>
                            ...
                            <span class=" h-[2px] w-16 bg-[#273461] dark:bg-white mx-auto mt-1 mb-[-5px]
